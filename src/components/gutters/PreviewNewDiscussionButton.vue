<template>
  <a class="new-discussion-button" href="javascript:void(0)" v-if="coordinates" :style="{top: coordinates.top + 'px'}" v-title="'토론 시작'" @mousedown.stop.prevent @click="createNewDiscussion(selection)">
